...
const HigherStudies = forwardRef<HTMLDivElement, Props>(({ formData }, ref) => {
    ...
    return (
        ...
        >
            ...
            <Typography paragraph>
                ...
                <strong>branch</strong>, Division <u>{branch}, {division}</u>, Roll No.: <u>{rollNo}</u><br />
                UID No. <strong>{uid}</strong>, Thakur College of Engineering and Technology, Kandivali,<br />
                Mumbai, residing at <u>________________________________________</u><br />
                <u>____________________________________________________________________</u>,
            </Typography>

            <Typography paragraph>
                hereby state that I am interested in and have given consent for <strong>Higher Studies</strong> and not interested in Campus Recruitment. I state and abide myself by the followings:
            </Typography>

            <Box component="ol" sx={{ pl: 3 }}>
                <li>I will register myself for the Higher Studies to HOC Cell as per the instructions.</li>
                <li>I am interested in Higher Studies and I will not opt for Campus Recruitment in future.</li>
                <li>I assure that I will not change the consent of Higher Studies for Campus Recruitment in any circumstances.</li>
                <li>
                ...
                <li>I have complete awareness that institute’s decision will be the final decision in this regard.</li>
                <li>
