...
const Entrepreneurship = forwardRef<HTMLDivElement, Props>(({ formData }, ref) => {
  const { user, uid } = formData;
  const [year, branchDivRoll] = uid.split("-");
  const branch = branchDivRoll.slice(0, 2); // e.g., IT
  const division = branchDivRoll.charAt(2); // e.g., B
  const rollNo = branchDivRoll.slice(3); // e.g., 01
  ...
  return (
    ...
    >
      ...
      <Typography paragraph>
        hereby state that I am interested in and have given consent for <strong>Entrepreneurship/Family Business</strong> and not interested in Campus Recruitment. I state and abide myself by the following:
      </Typography>

      <Box component="ol" sx={{ pl: 3 }}>
        <li>
          I will submit all the required documents related to <strong>Entrepreneurship/Family Business</strong> as per the instructions.
        </li>
        <li>
          I am interested in <strong>Entrepreneurship/Family Business</strong> and I will not opt for Campus Recruitment in future.
        </li>
        <li>
          I assure that I will not change the consent of <strong>Entrepreneurship/Family Business</strong> for Campus Recruitment in any circumstances.
        </li>
        <li>
          I will be submitting the following to T & P Cell:
          <Box component="ul" sx={{ pl: 3, listStyle: "lower-alpha" }}>
            <li>Proof of Entrepreneurship/Family Business or any other Communication</li>
          </Box>
        </li>
        <li>
